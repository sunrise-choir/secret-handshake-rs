// This file serves both as an example of using the `ClientHandshaker` struct, and as the test executable for the [shs1 testsuite](https://github.com/AljoschaMeyer/shs1-testsuite).
...
fn main() {
    ...
    let mut server_longterm_pk = [0u8; sign::PUBLICKEYBYTES];
    ...
    for i in 0..32 {
        ...
        server_longterm_pk[i] = server_longterm_pk_vec[i];
    }
